...
write.csv(a,file="~/Desktop/Class/learnR/Bib/JET/JETlocalkeywords.csv")
...
WC<-read.csv(file="~/Downloads/World_Collaboration_Map-2.csv",header=T)
#Removing the third column to make the edgefile
WCedge<-WC[,-c(3)]
#To generate network from the csv file, lets use igraph package
library(igraph)
#For more inclusinve visual features, lets also use statnet package
library(statnet)
